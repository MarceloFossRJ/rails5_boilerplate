...
Apartment.configure do |config|
  ...
  #
  config.excluded_models = ["User", "Identity", "Member", "Workspace", "Invitation", "UserPreference"]
  ...
  # end
  #
  config.tenant_names = lambda { Workspace.pluck :subdomain }
...
Apartment::Elevators::Subdomain.excluded_subdomains = ExcludedSubdomains.subdomains